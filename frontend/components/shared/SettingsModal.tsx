                ...
                <Space direction="vertical" size={32} style={{ width: '100%' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                            <SoundOutlined style={{ color: 'var(--accent-primary)', fontSize: 18 }} />
                            <div>
                                <Text strong style={{ color: 'rgba(255,255,255,0.9)', display: 'block', fontSize: 15 }}>High-Quality Audio (Better Voice)</Text>
                                <Text type="secondary" style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)' }}>Use AI-generated voice for consistent multi-browser support</Text>
                            </div>
                        </div>
                        <Switch checked={useBackendTTS} onChange={setUseBackendTTS} />
                    </div>
